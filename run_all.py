...
def main():
    ...
    parser.add_argument(
        ...
        nargs="+",
        required=True,
        help="List of video files (or camera indices) to simulate cameras",
    )
    ...
    parser.add_argument(
        "--reid_model_path", type=str, default="", help="Path to trained .pth checkpoint"
    )
    parser.add_argument(
        "--reid_flip_augment", action="store_true", help="Enable horizontal flip TTA"
    )
    ...
    for idx, video in enumerate(videos):
        ...
        cam_cmd = [
            ...
            video,
            "--zmq_endpoint",
            f"tcp://127.0.0.1:{args.zmq_port}",
            "--api_port",
            api_port,
            "--reid_model_name",
            args.reid_model_name,
        ]
