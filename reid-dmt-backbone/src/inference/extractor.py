...
class EnsembleReID:
    ...
    def _extract_for_model(self, model: torch.nn.Module, config: InferenceConfig, tensor_batch: torch.Tensor) -> torch.Tensor:
    ...
    def extract(self, image: Any, is_bgr: bool = True, return_dict: bool = False, fusion: str = "concat") -> Union[torch.Tensor, Dict[str, torch.Tensor]]:
